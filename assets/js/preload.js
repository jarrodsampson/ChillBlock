...
preload.prototype = {
	preload: function(){ 
	    ...
	    // using these
	    this.game.load.audio('introSong', ['audio/intro.mp3']);
	    this.game.load.audio('gameSong', ['audio/game-song.mp3']);
	    this.game.load.audio('orbhit', ['audio/orbhit.mp3']);
	    this.game.load.image('orb', 'game/orb.png');
	    this.game.load.image('paddle1', 'game/paddle1.png');
	    this.game.load.audio('crowdBoo', ['audio/boo.mp3']);
	    this.game.load.audio('ballHitItemSound', ['audio/ice.mp3']);
  	...
  	create: function(){
  		...
  		mainMusicSound = this.game.add.audio('introSong');
