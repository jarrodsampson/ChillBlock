...
gameTitle.prototype = {
    create: function() {
        ...
        // set storage
        if (localStorage.getItem('chillBlock_highscores') === null) {
            localStorage.setItem('chillBlock_highscores', "[]");
            console.log("Added HighScores");
        }

        if (localStorage.getItem('chillBlock_bestScore') === null) {
            localStorage.setItem('chillBlock_bestScore', "");
        ...
        console.log(JSON.parse(localStorage.getItem('chillBlock_highscores')).length);
        if (JSON.parse(localStorage.getItem('chillBlock_highscores')).length >= 1) {
